...
package com.example.jetpet.ui.theme
...
import com.example.jetpet.ui.utils.LocalSysUiController

private val LightColorPalette = JetpetColors(
    brand = Shadow5,
...
private val DarkColorPalette = JetpetColors(
    brand = Shadow1,
...
object JetpetTheme {
    val colors: JetpetColors
        @Composable
        get() = LocalJetpetColors.current
}
...
@Composable
fun ProvideJetpetColors(
    colors: JetpetColors,
    content: @Composable () -> Unit
) {
    val colorPalette = remember { colors }
    colorPalette.update(colors)
    CompositionLocalProvider(LocalJetpetColors provides colorPalette, content = content)
}

private val LocalJetpetColors = staticCompositionLocalOf<JetpetColors> {
    error("No JetpetColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [JetpetTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
